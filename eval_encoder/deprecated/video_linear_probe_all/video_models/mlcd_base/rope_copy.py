...
@register_model
def RoPE2d_ViT_S_16_512_copy(pretrained=False, **kwargs):
...
@register_model
def RoPE2d_ViT_B_16_1024_copy(pretrained=False, **kwargs):
    model = VisualTransformer(
        patch_size=16, 
        width=768, 
        layers=12,
...
def RoPE2d_ViT_bigG_14_1024(pretrained=False, **kwargs):
    model = VisualTransformer(
        patch_size=14, 
        width=1664, 
        layers=48,
...
def RoPE2d_ViT_SO400M(pretrained=False, **kwargs):
    model = VisualTransformer(
        patch_size=14, 
        width=1152, 
        layers=27,
...
def RoPE2d_ViT_L_14_1024(pretrained=False, **kwargs):
    model = VisualTransformer(
        patch_size=14, 
        width=1024, 
        layers=24,
...
def RoPE2d_ViT_t_2_1024(pretrained=False, **kwargs):
    model = VisualTransformer(
        patch_size=2, 
        width=128, 
        layers=12,
