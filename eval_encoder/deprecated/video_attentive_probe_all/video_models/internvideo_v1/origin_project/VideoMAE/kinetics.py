...
class RawFrameDataset(Dataset):
    ...
    def __init__(self,
        ...
        for i in range(len(self.total_frames)):
            self.total_frames[i] = os.path.join('/vlm/Monash/video_linear_probe/fewshot_video/ActionRecognition/k400/', self.total_frames[i])
